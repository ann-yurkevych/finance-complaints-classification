...
Predict the company response based on complaints. 
The target varible is ´Company response to the consumer´. 
...
## Feature Engineering
which features you chose, which deleted, text features.
